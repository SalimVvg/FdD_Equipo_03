...
| **Implementing SDG 14: Opportunities and challenges in a Caribbean Small Island Developing State.**<br>*(Thompson, 2025)* | Evaluación del nivel de implementación del ODS 14 en Trinidad y Tobago, analizando oportunidades y dificultades para alcanzar sus metas de conservación marina. | Analiza el cumplimiento de las metas del ODS 14 en un pequeño Estado insular en desarrollo (SIDS) y plantea recomendaciones para acelerar su ejecución institucional. | • **Indicadores de avance ODS 14:** Nivel de cumplimiento de metas globales.<br>• **Conservación de ecosistemas:** Estado y extensión de áreas marinas protegidas.<br>• **Capacidad de gestión institucional:** Eficiencia de políticas gubernamentales locales. |
| **The challenge of reducing macroplastic pollution: Testing the effectiveness of a river boom under real environmental conditions.**<br>*(Blettler et al., 2023)* | Evaluación de la eficacia de una barrera flotante (*river boom*) para capturar macroplásticos en condiciones ambientales reales de un río. | Prueba experimental de una tecnología de retención de residuos plásticos según diferentes configuraciones de la barrera. Demuestra que la eficiencia depende del tipo de plástico y la disposición instalada. | • **Muestra de residuos:** 52 artículos plásticos recopilados.<br>• **Diversidad de polímeros:** 13 tipos identificados.<br>• **Configuración de la barrera:** Configuración C (≈37 % eficacia) vs. Slash (<10 %).<br>• **Eficiencia de captura:** Rango de 0–100 %.<br>• **Propiedades físicas:** Forma, tipo de polímero y flotabilidad del residuo. |
...
## Tabla Comparativa: Impacto Ambiental, Ecotoxicidad y Análisis de Ciclo de Vida (LCA) de Residuos Plásticos

| Artículo Científico / Fuente | Tema | ¿Qué aporta? | Variables y Parámetros Operativos |
| :--- | :--- | :--- | :--- |
| **Efectos toxicopatológicos del filtro UV de protector solar, oxibenzona (benzofenona-3), en plánulas de coral y células primarias cultivadas y su contaminación ambiental en Hawái y las Islas Vírgenes de los EE. UU.**<br>*(Downs et al. / PubMed, 2016)*<br>[Ver artículo en PubMed](https://pubmed.ncbi.nlm.nih.gov/26487337/) | Evaluación de la ecotoxicidad y alteración fisiológica inducida por la oxibenzona (BP-3) en corales marinos (*Stylophora pistillata*). | Evidencia que la BP-3 actúa como un perturbador endocrino y fototóxico, induciendo la deformación, blanqueamiento, encuadramiento celular y daño en el ADN de las plánulas de coral a concentraciones ambientales. | • **Agente tóxico:** Concentración de Oxibenzona (BP-3) en microgramos/litro ($\mu\text{g/L}$).<br>• **Efectos fototóxicos:** Blanqueamiento y deformación morfológica de plánulas.<br>• **Genotoxicidad:** Nivel de fragmentación de ADN y lisis celular en luz/oscuridad.<br>• **Muestreo ambiental:** Concentraciones residuales en zonas arrecifales costeras. |
| **Degradación marina y ecotoxicidad de las bolsas de plástico convencionales, recicladas y compostables**<br>*(ScienceDirect, 2024)*<br>[Ver artículo en ScienceDirect](https://www.sciencedirect.com/science/article/pii/S0269749124008108) | Análisis comparativo de las tasas de degradación, fragmentación y lixiviación tóxica de bolsas de polímeros convencionales, recicladas y bioplásticos compostables en entorno marino. | Demuestra que los materiales etiquetados como "compostables" o "reciclados" no necesariamente se degradan eficazmente en condiciones marinas reales y pueden liberar lixiviados con alta ecotoxicidad para bioindicadores marinos. | • **Tipo de polímero:** Plásticos convencionales, reciclados y bioplásticos compostables.<br>• **Tasa de degradación:** Pérdida de masa y alteración de propiedades mecánicas en agua de mar.<br>• **Ecotoxicidad de lixiviados:** Tasa de mortalidad y toxicidad en organismos bioindicadores.<br>• **Generación de microplásticos:** Tasa de fragmentación superficial bajo radiación/oleaje. |
| **How sustainable and safe is drinking from refill-and-reuse bottles? An analysis based on life-cycle assessment (LCA) and microbiological quality of water**<br>*(PubMed, 2026)*<br>[Ver artículo en PubMed](https://pubmed.ncbi.nlm.nih.gov/41175910/) | Evaluación del impacto ambiental del ciclo de vida (LCA) y la calidad microbiológica del agua al comparar botellas reutilizables (aluminio, vidrio, HDPE, acero) contra botellas PET de un solo uso. | Demuestra que el uso de botellas reutilizables durante 1 año reduce drásticamente las emisiones de CO₂ en comparación con el PET de un solo uso. Además, prueba que el lavado en lavavajillas optimiza la reducción de la carga microbiana (~90 %) manteniendo bajo impacto ambiental. | • **Evaluación del ciclo de vida (LCA):** Potencial de Calentamiento Global ($\text{kg CO}_2\text{ eq}$) en producción vs. uso anual.<br>• **Material del contenedor:** Aluminio, vidrio, HDPE, acero inoxidable y PET.<br>• **Calidad microbiológica:** Conteo de unidades formadoras de colonias (UFC) de bacterias en el agua a lo largo del tiempo.<br>• **Métodos de higienización:** Lavado manual vs. lavavajillas de alta/baja eficiencia. |
...
<img src="https://github.com/user-attachments/assets/bd8e59fb-f2f4-4a6a-b259-2cbf79de9078" alt="presencia de microplásticos" width="500" />
